"5.Count the number of jobs across different industry across different locations. For instance,
  how many Frontend Engineer jobs are there in Bangalore 
as compared to Data Analytics jobs in Bangalore, 
